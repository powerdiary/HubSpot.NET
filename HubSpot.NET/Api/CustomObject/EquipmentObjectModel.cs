...
#nullable enable
        ...
        [DataMember(Name = "backoffice_id")] public string? BackofficeId { get; set; }
        ...
        [DataMember(Name = "equipment_title")] public string? EquipmentTitle { get; set; }
        ...
        [DataMember(Name = "hs_createdate")] public DateTime? HsCreateDate { get; set; }

        [DataMember(Name = "hs_lastmodifieddate")]
        public DateTime? HsLastModifiedDate { get; set; }

        [DataMember(Name = "hs_object_id")] public string? HsObjectId { get; set; }
        ...
        [DataMember(Name = "hs_read_only")] public bool? HsReadOnly { get; set; }
        ...
        [DataMember(Name = "hs_was_imported")] public bool? HsWasImported { get; set; }
        ...
        [DataMember(Name = "hubspot_team_id")] public string? HubspotTeamId { get; set; }

        [DataMember(Name = "item_number")] public string? ItemNumber { get; set; }

        [DataMember(Name = "karintest")] public string? KarinTest { get; set; }

        [DataMember(Name = "line_item_id")] public string? LineItemId { get; set; }
        ...
        [DataMember(Name = "make__other")] public string? MakeOther { get; set; }

        [DataMember(Name = "new_associated_deal")]
        public DateTime? NewAssociatedDeal { get; set; }

        [DataMember(Name = "photo")] public string? Photo { get; set; }

        [DataMember(Name = "poc_email")] public string? PocEmail { get; set; }

        [DataMember(Name = "product_id")] public string? ProductId { get; set; }
        ...
        [DataMember(Name = "seller_deal_id")] public string? SellerDealId { get; set; }
        ...
        [DataMember(Name = "year1")] public string? Year1 { get; set; }

        [DataMember(Name = "zip_code")] public string? ZipCode { get; set; }

        [DataMember(Name = "name")] public virtual string? Name { get; set; }

        [DataMember(Name = "model")] public string? Model { get; set; }

        [DataMember(Name = "vin")] public string? Vin { get; set; }

        [DataMember(Name = "hoursmileage")] public string? HoursMileage { get; set; }
