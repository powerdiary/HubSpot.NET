...
public interface IHubSpotContactApi
{
    ...
    Task<ContactListHubSpotModel<T>> ListAsync<T>(ListRequestOptions opts = null) where T : ContactHubSpotModel, new();
    ...
    Task<ContactListHubSpotModel<T>> RecentlyCreatedAsync<T>(ListRecentRequestOptions opts = null) where T : ContactHubSpotModel, new();

    ContactListHubSpotModel<T> RecentlyUpdated<T>(ListRecentRequestOptions opts = null) where T : ContactHubSpotModel, new();
    Task<ContactListHubSpotModel<T>> RecentlyUpdatedAsync<T>(ListRecentRequestOptions opts = null) where T : ContactHubSpotModel, new();

    ContactSearchHubSpotModel<T> Search<T>(SearchRequestOptions opts = null) where T : ContactHubSpotModel, new();
    Task<ContactSearchHubSpotModel<T>> SearchAsync<T>(SearchRequestOptions opts = null) where T : ContactHubSpotModel, new();
}
